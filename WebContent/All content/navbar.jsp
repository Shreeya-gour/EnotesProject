...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    {%>
      ...
      <a href="LogoutServlet"  method="post" class="btn btn-light my-2 my-sm-0" type="submit"><i class="fa fa-registered" aria-hidden="true"></i>logout</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <% }
        ...
        <a href="register.jsp" class="btn btn-light my-2 my-sm-0" type="submit"><i class="fa fa-registered" aria-hidden="true"></i>Register</a>
   <% 
    }
    %>
